...
const translations = {
  en: {
    ...
    // Editor / canvas (A4 designer, document canvas, style panel)
    properties: "Properties",
    selectItemToEdit: "Select an item to edit its properties",
    ...
    aiGenerateDiagram: "AI Diagram",

    // Thanh công cụ trình vẽ
    undo: "Undo",
    redo: "Redo",
    exportPdf: "Export PDF",
    exportPng: "Export PNG",
    exportedPng: "PNG exported",
    exportedPngDesc: "Your diagram has been saved as a PNG file",
    comingSoon: "Coming soon",
    pdfComingSoon: "PDF export is not available yet",

    // Quản lý mẫu A4
    a4DesignerTitle: "A4 & Diagram Designer",
    a4DesignerSubtitle: "Create and manage document templates and diagrams",
    newTemplate: "New template",
    createTemplateAction: "Create template",
    newTemplateDesc: "Name your template and add a short description",
    descriptionOptional: "Description (optional)",
    noDescriptionProvided: "No description",
    elementsCount: "elements",

    // Bảng thuộc tính hình
    shapeSettings: "Shape settings",
    selectShapeToEdit: "Select a shape to edit its properties",
    position: "Position",
    size: "Size",
    rotation: "Rotation",
    opacity: "Opacity",
    ...
    mermaidTheme: "Diagram theme",
    styleTab: "Style",
    propertiesTab: "Properties",

    // Bảng thuộc tính tài liệu
    typeLabel: "Type",
    positionAndSizeMm: "Position & size (mm)",
    fontSizePt: "Font size (pt)",
    borderRadiusPx: "Border radius (px)",
    paddingMm: "Padding (mm)",
    top: "Top",
    preserveAspectRatio: "Preserve aspect ratio",
    addItem: "Add item",
    grid: "Grid",

    // Thẻ tài khoản / ghi chú
    copyAll: "Copy all",
    ...
    websiteOrApp: "Website/App",
    toggleMenu: "Toggle menu",
    toggleTheme: "Toggle theme",
    userAvatar: "User Avatar",

    // Các key vốn được gọi bằng t() nhưng chưa có trong từ điển,
    // nên giao diện hiển thị đúng tên key (vd "resourceType", "confirmDeleteTask").
    task: "Task",
    note: "Note",
    account: "Account",
    taskName: "Task Name",
    ...
    deleteTaskError: "An error occurred while deleting the task",

    // Đã có ở vi nhưng thiếu ở en
  ...
  vi: {
    ...
    // Trình soạn thảo / canvas (A4 designer, document canvas, bảng thuộc tính)
    properties: "Thuộc tính",
    selectItemToEdit: "Chọn một đối tượng để chỉnh thuộc tính",
    selectedItem: "Đối tượng đang chọn",
    duplicate: "Nhân bản",
    width: "Chiều rộng",
    height: "Chiều cao",
    contentLabel: "Nội dung",
    enterTextPlaceholder: "Nhập nội dung...",
    imageLabel: "Hình ảnh",
    ...
    fontWeight: "Độ đậm",
    fontWeightNormal: "Thường",
    fontWeightBold: "Đậm",
    fontWeightLighter: "Mảnh",
    textColor: "Màu chữ",
    alignment: "Căn lề",
    alignLeft: "Trái",
    alignCenter: "Giữa",
    ...
    background: "Nền",
    border: "Viền",
    borderSolid: "Nét liền",
    borderDashed: "Nét đứt",
    ...
    layers: "Lớp",
    actions: "Thao tác",
    basicShapes: "Hình cơ bản",
    textAndMedia: "Văn bản & Media",
    dataAndDiagrams: "Dữ liệu & Sơ đồ",
    dataCard: "Thẻ dữ liệu",
    ...
    createFirstTemplate: "Tạo mẫu đầu tiên để bắt đầu",
    createNewTemplate: "Tạo mẫu mới",
    templateName: "Tên mẫu",
    templateNamePlaceholder: "Mẫu của tôi",
    describeTemplate: "Mô tả mẫu của bạn...",
    backToGallery: "Quay lại thư viện",
    aiGenerateDiagram: "Sơ đồ AI",
    ...
    exportedPngDesc: "Sơ đồ đã được lưu thành tệp PNG",
    comingSoon: "Sắp có",
    pdfComingSoon: "Tính năng xuất PDF chưa khả dụng",

    // Quản lý mẫu A4
    a4DesignerTitle: "Trình thiết kế A4 & Sơ đồ",
    a4DesignerSubtitle: "Tạo và quản lý mẫu tài liệu, sơ đồ",
    newTemplate: "Tạo mẫu mới",
    createTemplateAction: "Tạo mẫu",
    newTemplateDesc: "Đặt tên cho mẫu và thêm mô tả ngắn",
    descriptionOptional: "Mô tả (không bắt buộc)",
    noDescriptionProvided: "Chưa có mô tả",
    elementsCount: "đối tượng",

    // Bảng thuộc tính hình
    shapeSettings: "Thuộc tính hình",
    selectShapeToEdit: "Chọn một hình để chỉnh thuộc tính",
    position: "Vị trí",
    size: "Kích thước",
    rotation: "Góc xoay",
    opacity: "Độ mờ",
    ...
    mermaidCode: "Mã Mermaid",
    mermaidTheme: "Chủ đề sơ đồ",
    styleTab: "Kiểu dáng",
    propertiesTab: "Thuộc tính",

    // Bảng thuộc tính tài liệu
    typeLabel: "Loại",
    positionAndSizeMm: "Vị trí & kích thước (mm)",
    fontSizePt: "Cỡ chữ (pt)",
    borderRadiusPx: "Bo góc (px)",
    paddingMm: "Đệm trong (mm)",
    top: "Trên",
    preserveAspectRatio: "Giữ tỉ lệ",
    addItem: "Thêm đối tượng",
    grid: "Lưới",

    // Thẻ tài khoản / ghi chú
    copyAll: "Sao chép tất cả",
    figmaDesign: "Thiết kế Figma",
    gradient: "Chuyển sắc",
    desktop: "Máy tính",
    mobile: "Điện thoại",
    templatesTab: "Mẫu có sẵn",
    connectedStatus: "Đã kết nối",
    disconnectedStatus: "Mất kết nối",

    // Giao diện khác
    emailOrUsername: "Email/Tên đăng nhập",
    websiteOrApp: "Website/Ứng dụng",
    ...
    deleteTaskError: "Có lỗi xảy ra khi xóa công việc"
  },
}
...
// Trước đây `useLanguage` là hook có useState riêng, nên MỖI component giữ một
// bản state độc lập và không có nơi nào ghi localStorage. Hệ quả: bấm đổi ngôn
// ngữ chỉ đổi trong đúng component chứa nút bấm, phần còn lại của giao diện giữ
// nguyên, và lựa chọn mất khi tải lại trang. Dùng Context để cả app chia sẻ một
// state duy nhất và lưu lại lựa chọn.
...
function detectInitialLanguage(): Language {
  ...
  // Mặc định tiếng Việt, chỉ dùng tiếng Anh khi trình duyệt đặt ngôn ngữ en-*
  const nav = navigator.language || "vi"
  return nav.toLowerCase().startsWith("en") ? "en" : "vi"
}

export function LanguageProvider({ children }: { children: React.ReactNode }) {
  // Khởi tạo "vi" ở cả server lẫn lần render đầu của client để tránh lệch
  // hydration, rồi mới đồng bộ với localStorage trong effect.
  ...
  const t = useCallback(
    (key: string): string => {
      ...
      return dict[key] ?? translations.vi[key as keyof typeof translations.vi] ?? key
    },
    [language]
  )
